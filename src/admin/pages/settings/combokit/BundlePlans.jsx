          ...
          <div className="p-6">
            <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
              <button
                ...
                className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
              ...
              {countries.map((country) => (
                <button
                  ...
                  className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                    selectedCountries.has(country._id) ? 'border-blue-500 bg-blue-50 shadow-sm' : 'border-gray-100 bg-white hover:border-blue-300'
                  }`}
                >
              ...
              <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
                ...
                {availableStates.map((state) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                      selectedStates.has(state._id) ? 'border-indigo-500 bg-indigo-50 shadow-sm' : 'border-gray-100 bg-white hover:border-indigo-300'
                    }`}
                  >
            ...
            <div className="p-6">
              <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
                <button
                  ...
                  className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                    selectedClusters.size === clusterOptions.length && clusterOptions.length > 0
                ...
                {clusterOptions.map((cluster) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                      selectedClusters.has(cluster._id) ? 'border-purple-500 bg-purple-50 shadow-sm' : 'border-gray-100 bg-white hover:border-purple-300'
                    }`}
                  >
            ...
            <div className="p-6">
              <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
                <button
                  ...
                  className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                    selectedDistricts.size === districtOptions.length && districtOptions.length > 0
                ...
                {districtOptions.map((district) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                      selectedDistricts.has(district._id) ? 'border-emerald-500 bg-emerald-50 shadow-sm' : 'border-gray-100 bg-white hover:border-emerald-300'
                    }`}
                  >
            ...
            <div className="p-6">
              <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
                <button
                  ...
                  className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                    selectedCities.size === cityOptions.length && cityOptions.length > 0
                ...
                {cityOptions.map((city) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-48 p-4 rounded-xl border-2 selection-card text-center relative ${
                      selectedCities.has(city._id) ? 'border-orange-500 bg-orange-50 shadow-sm' : 'border-gray-100 bg-white hover:border-orange-300'
                    }`}
                  >
