...
const FranchiseProjectManagementLeadPartner = () => {
    ...
    const [resetPasswordData, setResetPasswordData] = useState({ managerName: '', newPassword: '', confirmPassword: '' });

    // Sample Manager Data (Restored mock data for now)
        ...
        <div className="container mx-auto px-4 py-3 max-w-7xl">
            ...
            <div className={showProfileView ? 'hidden' : ''}>
                <div className="bg-white rounded-lg shadow-sm mb-3 border-0">
                    <div className="p-6">
                        <h3 className="text-2xl mb-1 text-blue-600 font-semibold">Lead Partner</h3>
            ...
            {selectedManager && (
                <div className={showProfileView ? '' : 'hidden'}>
                    <div className="flex justify-between items-center mb-4">
                        <h4 className="text-xl font-semibold mb-0">Lead Partner Details</h4>
                        <button
                            type="button"
...
export default FranchiseProjectManagementLeadPartner;